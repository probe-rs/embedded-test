...
- Restored rust-analyzer `Run Test | Debug` buttons for `#[embedded_test::tests]` suites by generating IDE-visible `#[test]` wrappers.

## [0.7.1]

### Added

- Support embassy-executor v0.10.x via feature `embassy-010`
